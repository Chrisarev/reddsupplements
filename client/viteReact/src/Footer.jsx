        ...
        <div className={styles.footer}>
            <div className={styles.newsletterSection}>
                ...
                <form onSubmit={handleSubmit}>
                    <input disabled={submitState} type="email" />
                ...
                <div className={styles.socialsSection}>
                    ...
                    <div className={styles.iconsHolder}>
                        <div className={styles.icon}>
                            <svg fill="#000000" xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="xMidYMid" width="100%" height="100%"
            ...
            <div className={styles.linksSection}>
                <div className={styles.group}>
                    <h2>Our Products</h2>
                    <ul>
                        <Link to="/"><li>Protein</li></Link>
                        <Link to="/"><li>Preworkout</li></Link>
                        <Link to="/"><li>Workout Gear</li></Link>
                    </ul>
                </div>
                <div className={styles.group}>
                    <h2>Our Products</h2>
            ...
            <h3 className={styles.copyright}>©2023 ReddSupplements</h3>
        </div>
    )
}
